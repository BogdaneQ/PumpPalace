...
namespace PumpPalace.Migrations
{
    ...
    [Migration("20250101231052_Migracja25")]
    partial class Migracja25
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PumpPalace.Models.Product", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("AvailableColors")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("AvailableSizes")
                        .IsRequired()
                        .HasColumnType("text[]");
